  ...
  return (
      ...
      <p class="text-center ext-3xl font-bold text-black"> Metallurgy department</p>
        ...
        <div className="w-full flex flex-wrap justify-evenly">
            <div className="w-46 flex flex-col items-center mb-12">
               <a href="https://drive.google.com/drive/folders/1se0CLa67AElqMQi2WQAiIJr73PDr-i-g?usp=drive_link"> <img className="w-44 h-44" src="https://th.bing.com/th/id/OIP.z4h-LPCaNdjF4-CZiz-S1gHaH_?rs=1&pid=ImgDetMain"
                 alt=""/><p className="text-3xl font-bold text-black">1st semester</p></a>
                
            </div>
            <div className="w-46 flex flex-col items-center mb-12">
               <a href="https://drive.google.com/drive/folders/1se0CLa67AElqMQi2WQAiIJr73PDr-i-g?usp=drive_link">
               <img className="w-44 h-44" src="https://cdn4.vectorstock.com/i/1000x1000/87/03/number-2-two-symbol-sign-in-circle-2nd-second-vector-38528703.jpg"
                 alt=""/>
                <p className="text-3xl font-bold text-black mx-6">2nd semester</p>
               </a>
            </div>
            <div className="w-46 flex flex-col items-center mb-12">
            ...
            <div className="w-46 flex flex-col items-center mb-12">
               <a href="https://drive.google.com/drive/folders/1xB083jkZfZ3OokZnBZaZQTkyOrll0XcQ?usp=drive_link"> <img className="w-44 h-44" src="https://th.bing.com/th/id/OIP.3-22xhcEstNDUqPi7z2-rgHaH5?rs=1&pid=ImgDetMain"
                 alt=""/>
    ...
    <div className="h-auto w-100 flex flex-wrap flex-col items-center text-centre p-10">
       ...
       <div className="w-full flex flex-wrap justify-evenly">
           ...
           <div className="w-46 flex flex-col items-center mb-12">
              <a href=""> <img className="w-44 h-44" src="https://th.bing.com/th/id/OIP.5MplmStjHQZQf-Q6NsFP-QHaH_?rs=1&pid=ImgDetMain"
                alt=""/>
               <p className="text-3xl font-bold text-black mx-6">6th semester</p></a>
           </div>
           <div className="w-46 flex flex-col items-center mb-12">
              <a href=""> <img className="w-44 h-44" src="https://th.bing.com/th/id/OIP.-TqPVswAt5AtmLXIKJ4oSwHaH6?rs=1&pid=ImgDetMain"
                alt=""/>
               <p className="text-3xl font-bold text-black">7th semester</p></a>
           </div>
           <div className="w-46 flex flex-col items-center mb-12">
